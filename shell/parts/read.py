...
import psycopg2
conn = psycopg2.connect(host='127.0.0.1', port=4432, user='erp', dbname='release_0807', password='jmf12345')
cr = conn.cursor()
cr.execute("select id from product_template order by id desc")
new_id = cr.fetchall()[0][0]
res = {}
for line in open(r'new.csv','r').readlines():
